            ...
            link: function ($scope, $element, $attrs, $ngModelCtrl) {
                ...
                $scope.getButtonText = function () {
                    ...
                    if ($scope.selectedOptions && $scope.selectedOptions.length > 1) {
                        ...
                        if (totalSelected === 0) {
                            return $scope.labels && $scope.labels.select ? $scope.labels.select : ($scope.placeholder || 'Selecione');
                        } else {
                            return totalSelected + ' ' + ($scope.labels && $scope.labels.itemsSelected ? $scope.labels.itemsSelected : 'selecionados');
                        }
                    } else {
                        return $scope.labels && $scope.labels.select ? $scope.labels.select : ($scope.placeholder || 'Selecione');
                    }
